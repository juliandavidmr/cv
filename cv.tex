...
\section*{Participaciones, premios y experiencia}

\begin{itemize}
\item {\bf Participaciones }

\leftskip 0.5in
\parindent -0.5in
\subitem Ganador de la 1ra Hackat\'on de desarrollo de Software realizada por Indigo Technologies. 2016.
\subitem{Participante de la marat\'on nacional de programaci\'on por ACIS/REDIS en los a\~nos 2014, 2015 y 2016. Bogot\'a, Colombia. }
\subitem{Participante de la marat\'on regional latinoamericana de programaci\'on por ACIS/REDIS en 2016. Bogot\'a, Colombia.}
\subitem{Participaci\'on en el encuentro de programadores realizado por CCPL \textit{(Colombian Collegiate Programming League)} y Google Inc, 2016. Bogot\'a, Colombia.}
...
\leftskip 0.5in
\parindent -0.5in
\subitem{Instructor del diplomado en desarrollo de aplicaciones m\'oviles h\'ibridas usando Ionic Framework versi\'on  2 y 3. Semillero de investigaci\'on GIECOM. Florencia, Caquet\'a. 2017}


\leftskip 0in
\parindent 0in

\item {\bf Labores realizadas }

\leftskip 0.5in
\parindent -0.5in
\subitem{Desarrollador de Software en el Departamento de Educaci\'on a Distancia, Universidad de la Amazonia. Florencia, Caquet\'a. (2017 -- 2018)}
\end{itemize}
